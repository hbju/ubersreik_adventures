...
function characterFixture(id: string, weapons: string[], talents: Record<string, number> = {}): Character {
    ...
    return {
        ...
        skills: [
            ...
            { id: 'ranged_throwing', name: 'Ranged (Throwing)', characteristic: 'bs', advances: 0, talents: 0, modifier: 0 },
            ...
            { id: 'melee_parry', name: 'Melee (Parry)', characteristic: 'ws', advances: 0, talents: 0, modifier: 0 },
        ],
        status: {
