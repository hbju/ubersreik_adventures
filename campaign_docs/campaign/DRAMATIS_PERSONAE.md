...
- **Grey Seer Rasknitt** — architect of the network; destroyed Wahlund's Stromfels cult years ago. Not yet seen.
- Rearguard fought in S13: Rat Ogre ✝, 2 Clanrats ✝, **Clawleader escaped** (knows armed surfacers are hunting).
...
## THE RESISTANCE (JUNGFREUD)
- **Lady Isolde Blucher** — Poetry Circle hostess; warm to "Ryan"; pamphlet task fulfilled; bigger task incoming (find who stole the blackpowder — Ludwig already knows if he is able to do the link with the bandits).
- **Capt. Erwin Blucher** — arch-opportunist; wants a strong Freiburg; tolerates his wife's "circus"; measured "Ryan" once.
- **Guido Falck** — hidden leader (textile-merchant guise); still evaluating Ryan; expected to engage at the Circle on the 15th.
- **'Sir' Kuno von Holzen** — former PC (see Session 0); charlatan knight; Johanna is using him (he wants her money/name; she sees through him).
- **Anton Grimski** — firebrand agitator at the Marktplatz Sprichstumpf; secretly Jungfreud-paid; drank with Ludwig & Silas at the Good Wife; some trust gained; gave nothing away about his employers.
- Heinrich von Saponatheim (nervous cousin), Frau Kellner (innocent, enthusiast and rich widow coming at the Poetry Circle).
...
- **Jannik Fanger ✝** — shot point-blank by Hannah, as they were fleeing the Sorcerer's Way; found by Pieter; publicly mourned as Heske's hero; Herald coverage incoming.
